  ...
  return (
    <div>
      ...
      <span className='w-[750px] h-2 bg-slate-700/20 mt-4 mb-16 rounded-full'></span>
          ...
          <div className='hover:scale-105 transition-all flex items-center justify-around bg-white drop-shadow-md max-sm:flex-col w-full p-4'>
          <img src={TKBB} className='w-96 drop-shadow-md shadow-inner rounded-2xl mr-12 w-96 h-48 max-sm:mr-0'/>
              ...
              <p className='w-[950px] max-md:w-96 max-md:text-sm'> &gt; Web uygulamaları ve kullanıcı arayüzleri oluşturmak için React.js framework'ünü kullanarak komponentler geliştirdim <br/>
            ...
            <div className='hover:scale-105 transition-all flex items-center justify-around bg-white drop-shadow-md shadow-inner p-4 mt-8 max-md:flex-col-reverse w-full'>
              <span>
                <div className='flex justify-between'>
                <h1 className='text-2xl mb-2 max-md:text-xl max-md:mb-8'>Sağlık Bilimleri Üniversitesi Websitesi</h1>
                <h1 className='text-xl max-md:opacity-0'>(Destek)</h1>
                </div>
                <p className='w-[950px] max-md:w-96 max-md:text-sm'>&gt; React.js ve Redux kullanarak dinamik olarak komponentler geliştirdim.<br/>
            ...
            <div className='hover:scale-105 transition-all flex items-center justify-around bg-white drop-shadow-md shadow-inner mt-8 mb-20 p-4 max-md:flex-col w-full'>
            <img src={Payna} className='w-96 h-48  drop-shadow-md shadow-inner rounded-2xl mr-12 max-sm:mr-0'/>
              <span>
                <div className='flex justify-between'>
                <h1 className='text-2xl mb-2 max-md:text-xl max-md:mb-8'>Payna Yazılım ve Danışmanlık Websitesi</h1>
                <h1 className='text-xl max-md:opacity-0'>(Teslim)</h1>
                </div>
                <p className='w-[950px] max-md:w-96 max-md:text-sm'>&gt; Kullanıcı deneyimi için UI kitleri veya özel stiller kullanarak görsel olarak çekici ve kullanıcı dostu arayüzler oluşturdum. <br/>
