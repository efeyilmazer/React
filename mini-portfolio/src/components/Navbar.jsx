...
<div className='bg-white w-screen h-20 flex justify-center items-center drop-shadow-md shadow-inner mt-8 gap-4 z-30'>
    ...
    <div className='flex items-center justify-center w-[720px] text-xl'>
      ...
      <span className='max-md:flex max-md:flex-col'>
        <button className=' ml-16 mr-4 max-md:mr-0 max-md:border-b max-md:border-l max-md:ml-0 max-md:rounded-none bg-white w-32 h-12 rounded-b-2xl hover:drop-shadow-xl hover:scale-110 transition-all drop-shadow-sm active:scale-100 max-md:hover:scale-100 max-md:hover:drop-shadow-none'onClick={() => navigate("/Projelerim")}>Projelerim</button>
        <button className=' bg-white w-32 h-12 max-md:border-l max-md:rounded-none rounded-b-2xl hover:drop-shadow-xl hover:scale-110 transition-all drop-shadow-sm active:scale-100 max-md:hover:scale-100 max-md:hover:drop-shadow-none' onClick={() => navigate("/Iletisim")}>İletişim</button>
      </span>
    </div>
</div>
