...
<div className='absolute left-2 top-[77px] z-40 flex items-center justify-center gap-2'>
    <span className='text-3xl opacity-50 hover:opacity-100 cursor-pointer active:scale-90'><a href="github.com/efeyilmazer" target='_blank'><FaGithubSquare color='#2b3137'/></a></span>
    <span className='text-3xl opacity-50 hover:opacity-100 cursor-pointer active:scale-90'><a href="linkedin.com/in/efe-y%C4%B1lmazer-19b822228/" target='_blank'><FaLinkedin color='#0077B5'/></a></span>
    <span className='text-3xl opacity-50 hover:opacity-100 cursor-pointer active:scale-90'><a href="instagram.com/efeyilmazer.1" target='_blank'><FaInstagramSquare color='#C13584'/></a></span>
  </div>
<div className='bg-white w-screen h-20 flex justify-center items-center drop-shadow-md shadow-inner mt-8 gap-4 z-30'>
    ...
    <div className='flex items-center justify-center w-[720px] text-xl'>
      <span>
        <button href="#tecrube" className=' bg-white w-32 h-12 rounded-b-2xl hover:drop-shadow-xl hover:scale-110 transition-all drop-shadow-sm active:scale-100' onClick={() => navigate("/Tecrubelerim")}>Tecrübelerim</button>
